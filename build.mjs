...
export const PAGES = {
  de: {
    ...
    description: 'Kanzlei Dr. Dr. Hausmann: Steuerberatung & Steuerrecht in Berlin. Fachanwalt für Steuerrecht, Steuerstrafrecht und Steuergestaltung für Unternehmen. Über 30 Jahre Erfahrung. Jetzt Beratung anfragen.',
    ...
    ogDescription: 'Steuerberatung & Steuerrecht in Berlin. Fachanwalt für Steuerrecht, Steuerstrafrecht und Steuergestaltung für Unternehmen. Über 30 Jahre Erfahrung.',
  ...
  en: {
    ...
    description: 'Kanzlei Dr. Dr. Hausmann: Tax law and legal counsel in Berlin. Attorney specialising in tax law, criminal tax law and tax planning for businesses. Over 30 years of experience. Arrange a consultation now.',
    ...
    ogDescription: 'Tax law and legal counsel in Berlin. Attorney specialising in tax law, criminal tax law and tax planning for businesses. Over 30 years of experience.',
  ...
  fr: {
    ...
    description: "Kanzlei Dr. Dr. Hausmann : droit fiscal et conseil juridique à Berlin. Avocat spécialisé en droit fiscal, droit pénal fiscal et planification fiscale pour entreprises. Plus de 30 ans d'expérience. Demandez une consultation dès maintenant.",
    ...
    ogDescription: "Droit fiscal et conseil juridique à Berlin. Avocat spécialisé en droit fiscal, droit pénal fiscal et planification fiscale pour entreprises. Plus de 30 ans d'expérience.",
  ...
  ru: {
    ...
    description: 'Kanzlei Dr. Dr. Hausmann: налоговое право и юридические консультации в Берлине. Адвокат, специализирующийся на налоговом праве, налоговом уголовном праве и налоговом планировании для бизнеса. Более 30 лет опыта. Запишитесь на консультацию прямо сейчас.',
    ...
    ogDescription: 'Налоговое право и юридические консультации в Берлине. Адвокат, специализирующийся на налоговом праве, налоговом уголовном праве и налоговом планировании для бизнеса. Более 30 лет опыта.',
